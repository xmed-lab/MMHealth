...
"""
# File       : fidscore.py
# Time       ：11/11/2024 11:05 am
# Author     ：Chuang Zhao
# version    ：python 
# Description：计算和真实的分布差异。（或许可以用Jaccard distribution来计算）;FID 值越小，表示生成图像与真实图像的相似度越高，生成质量越好。一般来说，FID 值在 0 到 100 之间较为常见，值越接近 0 表示生成效果越好。
"""
